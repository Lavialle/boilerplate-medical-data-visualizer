...
# 4
def draw_cat_plot():
    categorical_vars = ['cholesterol','gluc','smoke','alco','active','overweight']
...
def draw_heat_map():
    ...
    # 15
    sns.heatmap(corr, ax=ax, mask=mask, annot=True, fmt=".1f", cmap='coolwarm', square=True, linewidths=0.5)
